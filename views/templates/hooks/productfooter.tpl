				...
				<form action="{$link->getModuleLink('okom_moreinfo')}"  id="moreinfo_frm"  method="post" class="contact-form-box" enctype="multipart/form-data">
					<div class="moreinfo_form_container">
						...
						<p class="form-group">
							...
							<input id="moreinfo_firstname" class="form-control grey validate" data-validate="isGenericName" name="moreinfo_firstname" type="text" value=""/>
						</p>

						 <p class="form-group">
							<label for="moreinfo_email">{l s='Email' mod='okom_moreinfo'} <sup class="required">*</sup> :</label>
							<input class="form-control grey validate" id="moreinfo_email" name="moreinfo_email" data-validate="isEmail" value="" type="text">
						</p>
					...
					<p class="submit">
						...
						<button id="moreinfo_submit" class="btn button button-small" name="sendEmail" type="submit">
